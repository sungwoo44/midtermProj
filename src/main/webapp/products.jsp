	...
	<form action="">
		<select name="category">
			...
			<c:forEach items="${cateList }" var="cate">
				<option value="${cate.code}" ><c:out value="${cate.name }"/>(<c:out value="${cate.code}"/>) </option>
			</c:forEach>
		</select>
...
<!-- cdn: contents deliver network  // 부트스트랩으로 모달 메소드 사용하기 위해서 아래 한줄 작성!-->
	...
	<script type="text/javascript" src="assets/js/product_post.js"></script>
	<script type="text/javascript" src="assets/js/product_search.js"></script>
